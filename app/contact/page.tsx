...
import { CircleIcon } from '@/app/components/ui/icons';
import { Map } from '@/app/components/ui/map';

export const metadata: Metadata = {
    title: "Contact - SMSS Customer Support",
...
export default function ContactPage() { 
    ...
    return (
        <main
            className="
            w-[90vw] max-w-sm md:max-w-5xl mx-auto py-[4.2rem]
            grid gap-10 
            ...
            <section
                ...
                <address>
                    <dl>
                        ...
                        <dd>
                            <a href="mailto:orders@smssfakeshopmail.com
